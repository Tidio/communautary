...
class mh_magazine_youtube_widget extends WP_Widget {
    function mh_magazine_youtube_widget() {
        $widget_ops = array('classname' => 'mh_magazine_youtube_widget', 'description' => __('Widget to display a YouTube Video.', 'mh'));
        $this->WP_Widget('mh_magazine_youtube_widget', __('MH YouTube Video', 'mh'), $widget_ops);
    }
